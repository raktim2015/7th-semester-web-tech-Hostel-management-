...
const populateRowsSubmitted = (data) => {
  ...
  let temprows = []
  const filterRows = data.filter((obj) => obj.submittedStatus===3)
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar numSelected={selected.length} selected={selected} onReject={handleReject} onAccept={handleAccept} onSubmit={handleSubmit} />
...
export default TableTileVerified;